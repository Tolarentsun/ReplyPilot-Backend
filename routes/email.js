...
function welcomeEmail(name) {
  ...
  <div style="font-family:sans-serif;max-width:600px;margin:0 auto;background:#FAF8F4;padding:40px 32px;border-radius:12px">
    ...
    <p style="font-size:13px;color:#6B6878;line-height:1.6">You're on the free Starter plan — up to 5 reviews and 3 AI responses to get started. Upgrade anytime from your dashboard for unlimited access. Questions? Reply to this email.</p>
